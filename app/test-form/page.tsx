...
export default function TestFormSearchPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-gray-900 p-6 rounded-lg">
          ...
          <div className="text-gray-300 space-y-2">
            ...
            <p>2. <strong>Press Enter OR click Search button</strong> - both should work</p>
            <p>3. <strong>Watch the debug info</strong> - shows query, length, loading status, results count</p>
            ...
            <p>6. <strong>Blue message box</strong> shows form submission status</p>
          </div>
        </div>
      </div>
    </div>
